...
%% Geometry
x = [0:0.125:2,2*ones([1,7]),2:-0.125:1,ones([1,7]),1:-0.125:0,zeros([1,15])];
y =[zeros([1,16]),0:0.125:1,ones([1,7]),1:0.125:2,2*ones([1,7]),2:-0.125:0.125];
xo = x;
yo = y;
x(1,end+1) = x(1);
y(1,end+1) = y(1);
...
patch('faces',edge(:,1:2),'vertices',nodem, ...
    ...
    [uix,uiy]=InnerDisplacement( x,y,1.5,0.5,ux,uy,n,nu,mu,f,u );
